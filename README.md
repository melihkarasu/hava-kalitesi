# 💨 Canlı Hava Kalitesi Radarı

Dünya şehirlerinin canlı PM2.5, PM10, NO2 kirlilik seviyeleri, Avrupa AQI endeksi ve sağlık tavsiyeleri.
...
- **API Source:** OpenAQ / Air Quality API
